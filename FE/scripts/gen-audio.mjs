...
const LESSONS = [
  'src/app/data/contract-lesson-1.json',
  'src/app/data/marketing-lesson-2.json',
  'src/app/data/warranty-lesson-3.json',
  'src/app/data/business-planning-lesson-4.json',
];

// Long-form passage files (1 MP3 per passage, English narration)
const PASSAGES = [
  'src/app/data/contract-lesson-1-passage.json',
  'src/app/data/marketing-lesson-2-passage.json',
  'src/app/data/warranty-lesson-3-passage.json',
  'src/app/data/business-planning-lesson-4-passage.json',
];
