...
import passageData from '../../../data/contract-lesson-1-passage.json';
...
@Component({
  selector: 'app-contract-passage',
  standalone: true,
  imports: [PageHeadComponent, TooltipTextComponent],
  templateUrl: './contract-passage.component.html',
  styleUrl: './contract-passage.component.scss',
})
export class ContractPassageComponent {
