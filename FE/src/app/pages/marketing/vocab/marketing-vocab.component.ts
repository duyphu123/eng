...
import MARKETING_LESSON_2 from '../../../data/marketing-lesson-2.json';
import type { VocabEntry } from '../../../data/types';

@Component({
  selector: 'app-marketing-vocab',
  standalone: true,
  imports: [
  ...
  templateUrl: './marketing-vocab.component.html',
  styleUrl: './marketing-vocab.component.scss',
})
export class MarketingVocabComponent {
  readonly tts = inject(TtsService);

  readonly vocab = MARKETING_LESSON_2 as VocabEntry[];
