...
@Builder
@Entity
@Table(name = "sync_staff_register")
public class SyncStaffRegister {
    ...
    @Column(name = "bus_type", length = 100)
    ...
    @Column(name = "reg_old_link", length = 100)
    private String regOldLink;

    @Column(name = "reg_new_link", length = 100)
    private String regNewLink;

    @Column(name = "reg_smartphone", length = 100)
    private String regSmartphone;

    @Column(name = "bts_code", length = 50)
    private String btsCode;

    @Column(name = "lucky_code", length = 50)
    ...
    @Column(name = "account_emoney", length = 50)
